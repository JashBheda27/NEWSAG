                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                    ...
                    <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3 w-full sm:w-auto flex-wrap">
                      <button 
                        ...
                        className="text-[9px] sm:text-[10px] font-normal uppercase tracking-widest text-slate-700 dark:text-slate-200 px-2 py-1 rounded hover:text-white dark:hover:text-white hover:bg-indigo-600 dark:hover:bg-indigo-500 transition-colors"
                      >
                        Close
                      </button>
                      <button 
                        onClick={() => window.open(article.url, '_blank')}
                        className="text-[9px] sm:text-[10px] font-normal uppercase tracking-widest border border-slate-800 dark:border-slate-200 px-2.5 sm:px-3 py-1 text-slate-900 dark:text-slate-100 bg-[#ececec] dark:bg-slate-900/80 hover:text-white dark:hover:text-white hover:border-indigo-600 dark:hover:border-indigo-300 hover:bg-indigo-600 dark:hover:bg-indigo-500 transition-colors"
                      >
                        Read Full Article
                      </button>
                    </div>
