...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-auto border-t border-gray-200 dark:border-slate-800 py-8 px-4 sm:px-6 lg:pl-[336px] md:pl-[92px] bg-white dark:bg-slate-900 overflow-x-hidden">
      <div className="w-full flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
               ...
               <div className="flex flex-col">
                 <span className="font-black text-gray-900 dark:text-white text-sm">NewsAura</span>
                 <span className="text-xs text-gray-600 dark:text-slate-400">AI-Powered News Platform</span>
               </div>
          </div>
